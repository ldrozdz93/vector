//! Shared Azure client construction: authentication, connection-string handling,
//! and HTTP transport assembly for the new official Azure SDK (`azure_core` 1.0).
//!
//! Used by both Azure sinks (via re-exports in `crate::sinks::azure_common`) and
//! the `azure_blob` source.
#![allow(missing_docs)]
...
use azure_core::http::{ClientMethodOptions, Url};
...
use crate::azure::connection_string::{Auth, ParsedConnectionString};
use crate::azure::shared_key_policy::SharedKeyAuthorizationPolicy;
